...
TCL_LIB_FILE='libtcl8.4${TCL_DBGX}.a'
...
# installed.
TCL_PREFIX='/scratch/ultra/toolchain-stable/install-2010-03-20-stable'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/scratch/ultra/toolchain-stable/install-2010-03-20-stable'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/scratch/ultra/toolchain-stable/work/ubicom32-linux-uclibc/tcl/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/scratch/ultra/toolchain-stable/install-2010-03-20-stable/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/scratch/ultra/toolchain-stable/install-2010-03-20-stable/include'
...
# compiled.
TCL_SRC_DIR='/scratch/ultra/toolchain-stable/ubicom32toolchain/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/scratch/ultra/toolchain-stable/install-2010-03-20-stable/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/scratch/ultra/toolchain-stable/work/ubicom32-linux-uclibc/tcl/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/scratch/ultra/toolchain-stable/install-2010-03-20-stable/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/scratch/ultra/toolchain-stable/work/ubicom32-linux-uclibc/tcl/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/scratch/ultra/toolchain-stable/install-2010-03-20-stable/lib/libtclstub8.4${TCL_DBGX}.a'
