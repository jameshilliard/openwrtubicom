...
#define __TARGET_ARCH__ "ubicom32"
#define __FORCE_OPTIONS_FOR_ARCH__ 1
#undef __CONFIG_UC_UBICOM32_V3__
#define __CONFIG_UC_UBICOM32_V4__ 1
...
#define __KERNEL_HEADERS__ "$(ROOTDIR)/$(LINUXDIR)/arch/$(TARGET_ARCH)/include"
...
/* Security options */
#define __UCLIBC_HAS_ARC4RANDOM__ 1
