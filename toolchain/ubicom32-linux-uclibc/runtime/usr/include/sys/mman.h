...
static __inline__ int msync (void *__addr, size_t __len, int __flags )
{
	(void)__addr; (void)__len;  (void)__flags;
	return 0;
}
...
static __inline__ int mlock (__const void *__addr, size_t __len)
{
	(void)__addr; (void)__len;
	return 0;
}
static __inline__ int munlock (__const void *__addr, size_t __len)
{
	(void)__addr; (void)__len;
	return 0;
}
static __inline__ int mlockall (int __flags) { (void)__flags; return 0; }
